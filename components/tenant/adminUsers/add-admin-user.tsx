...
import { Building2, Loader2, Lock, Mail, UserPlus, X } from 'lucide-react';
...
import { addAdminUser} from '@/app/s/[subdomain]/adminUsers/actions';
...
export function AddAdminUser() {
  ...
  const { mutateAsync, isPending: isLoading } = useMutation({
    mutationFn: (data: z.infer<typeof formSchema>) => addAdminUser(data),
    onSuccess: (data) => {
      toast({
        title: data.message
      });
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Crie um novo usuário para acessar o sistema. Preencha todos os
            campos obrigatórios.
          </DialogDescription>
        </DialogHeader>
